...
const Home = () => {
  ...
  const [geoData, setGeoData] = useState<any>(null); // GeoJSON suele ser complejo, any es aceptable aquí o usar @types/geojson
      ...
      <div className="relative flex size-full min-h-screen flex-col bg-white overflow-x-hidden">
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-[#5e8d81] text-lg font-medium">Sincronizando datos epidemiológicos...</p>
          </div>
        </div>
      </div>
    );
        ...
        <main className="px-10 lg:px-40 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <section aria-labelledby="parasite-summary">
              <h2 id="parasite-summary" className="text-[#101816] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">
            ...
            <section aria-labelledby="epidemiology-stats">
              <h2 id="epidemiology-stats" className="text-[#101816] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">
