...
function History() {
  ...
  const [selectedDays, setSelectedDays] = useState([5, 30]);
      ...
      <div className="layout-container flex h-full grow flex-col">
        ...
        <div className="gap-1 px-6 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col w-80">
            <div className="px-4 py-3">
              <label className="flex flex-col min-w-40 h-12 w-full">
                <div className="flex w-full flex-1 items-stretch rounded-lg h-full">
                  ...
                  <input
                    placeholder="Buscar por fecha, hora o tipo de parásito"
            ...
            <h3 className="text-[#101816] text-lg font-bold leading-tight tracking-[-0.015em] px-4 pb-2 pt-4">Filtrar por Tipo de Parásito</h3>
            <div className="px-4">
            ...
            <h3 className="text-[#101816] text-lg font-bold leading-tight tracking-[-0.015em] px-4 pb-2 pt-4">Filtrar por Nivel de Confianza</h3>
            <div className="@container">
              <div className="relative flex w-full flex-col items-start justify-between gap-3 p-4 @[480px]:flex-row">
                <p className="text-[#101816] text-base font-medium leading-normal w-full shrink-[3]">Nivel de Confianza</p>
            ...
            <h3 className="text-[#101816] text-lg font-bold leading-tight tracking-[-0.015em] px-4 pb-2 pt-4">Filtrar por Fecha</h3>
            ...
            <h3 className="text-[#101816] text-lg font-bold leading-tight tracking-[-0.015em] px-4 pb-2 pt-4">Filtrar por Estado de Retroalimentación</h3>
