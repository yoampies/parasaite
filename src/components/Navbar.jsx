    ...
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f5f4] px-10 py-3">
      ...
      <div className="flex flex-1 justify-end gap-8">
        <div className="flex items-center gap-9">
          {/* Se utilizan componentes `Link` para una navegación interna eficiente */}
          <Link className="text-[#101816] text-sm font-medium leading-normal" to="/">Inicio</Link>
          <Link className="text-[#101816] text-sm font-medium leading-normal" to="/scanner">Escáner</Link>
          <Link className="text-[#101816] text-sm font-medium leading-normal" to="/history">Historial</Link>
          <Link className="text-[#101816] text-sm font-medium leading-normal" to="/library">Parásitos</Link>
        </div>
        ...
        <div 
          ...
          style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuDEzPYZIg_4qY3MD2g14DTr8--qPLeAQ-kUgUH6yqFdFAlpFQMlWFWbYxaYMvHnt85bpgR2c1hsy3ZkYd-LFLCJ1elRbOALjD1LIjx9Lfjw3Wr-yO3JBOquEXoUAj7dYLY0coN6W0Kz2tPafXkbrC6QKmQL2g_lnE2V7ft6j84CowEUlUJ8GDJ5xtqDGYNNJsUD19bqtglkIEYN4BewXReYaQXdMFWBUDszy2qFWk2S-rFQVL-l2qP2ps_J8sNVWQ9Au-VNgsUF7LWn")' }}
          role="img" // Se añade rol para accesibilidad
          aria-label="User profile picture" // Se añade etiqueta para accesibilidad
        ></div>
      </div>
    </header>
  );
