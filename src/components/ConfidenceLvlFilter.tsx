...
import { ConfidenceLvlFilterProps } from "../types";

const DEFAULT_RANGE = [0, 100];

function ConfidenceLvlFilter({ 
  title, 
  onRangeChange, 
  initialRange = DEFAULT_RANGE 
}: ConfidenceLvlFilterProps) {
  const [confidenceRange, setConfidenceRange] = useState<number[]>(initialRange);
